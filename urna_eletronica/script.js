  ...
  if (candidato.length > 0) {
    ...
    for (let i in candidato.fotos) {
      if (candidato.fotos[i].small) {
        fotosHtml += `<div class="divisao-1-imagem small"><img src="imagens/${candidato.fotos[i].url}" alt="">${candidato.fotos[i].legenda}</div>`;
      } else {
        fotosHtml += `<div class="divisao-1-imagem"><img src="imagens/${candidato.fotos[i].url}" alt="">${candidato.fotos[i].legenda}</div>`;
      }
    }
